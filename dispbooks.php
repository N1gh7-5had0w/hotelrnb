...
<body>
<?php	
	$sql = "Select cname, rno, checkin, days from customer c, books b
		where c.cid=b.cid";
	$result = selectbooks($sql);
...
<div id="scroll">
<table id="disp">
<tr> <th> Customer's Name </th> <th> Room Number </th> <th> Check-in Date </th> <th> Days &ensp; </th> </tr>
<?php		
		if ($result->num_rows > 0)
		{
		while($row = $result->fetch_assoc())
			{
 echo "<tr><td>" . $row["cname"]. "</td><td>" . $row["rno"]. "</td><td>" . $row["checkin"]. "</td><td>" . $row["days"]. "</td></tr>";
			}
		echo "</table>";
		}
	else
