...
<body>
<?php	
	$sql1 = "Select tno from tables";
	$resultt = selectreserves($sql1);
	$sql2 = "Select cid, cadd from customer";
	$resultc = selectreserves($sql2);
...
<!--	<table>
	...
	<form action="indexreserves.php" method="post">
	 ...
	 <div id="scroll">	 <td class="textinput"><select name="cid" size="1">
...
<!--		<td class="textinput"><input type="text" name="cid"></td></tr>	-->
	 ...
	 <div id="scroll">	 	<td class="textinput"><select name="tno" size="1">
