...
<div id="scroll">
<table id="disp">
<tr> <th> Room Number </th> <th> Type &ensp; </th>  <th> Bed Count </th> <th> Room Price </th> </tr>
<?php		
		if ($result->num_rows > 0)
		{
		while($row = $result->fetch_assoc())
			{
 echo "<tr><td>" . $row["rno"]. "</td><td>" . $row["rtype"]. "</td><td>" . $row["bedcount"]. "</td><td>" . $row["rprice"]. "</td></tr>";
			}
		echo "</table>";
		}
	else
